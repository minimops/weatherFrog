...
$$
  TLS(X) =  1 - \sum_{l = 1}^{40}{|\frac{x_l}{N} - w_l|}
$$ $$
...
$$
$$
  avgSil(S) = \frac{1}{3} \sum_{i = 1}^3{\text{Silhouettenkoeffizient}(s_i)}
$$
$$
