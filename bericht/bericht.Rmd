...
Mittermeier \n|\n|\n"
  Prof. Dr. Helmut Küchenhoff\n| Projektpartner: Maximilian Weigert und Magdalena
abstract: |
  to be written.
---
...
## Clusterbewertungskriterien
  ...
  **Timeline**  
  ...
  \textcolor{red}{insert gwl timeline plot}
  
  -plot etwas beschreiben
  -wie erwarten wir es am besten
  -wie ist es zu einem Wert zu bringen
...
Ab. 10 stellt dar, wie häufig jedes Cluster im Zeitraum 1971 bis 2000 vorkommt. 
...
Der Mosaikplot in Abb. 11 visualisiert die relativen Häufigkeiten der Winter- und Sommertage in jedem Cluster. 
...
Nun wird betrachtet, wie sich der Mittelwert des Luftdrucks und  der Mittelwert des Geopotentials räumlich unterscheidet. Abb 5 bzw. Abb.6 stellt pro  Cluster und für jeden der insgesamt 160 Standorte das arithmetrische Mittel der mslp bzw. geoppot Werte im Zeitraums 1971 – 2000 dar.
