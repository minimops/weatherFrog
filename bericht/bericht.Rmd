...
Weitere Distanzmetriken, die ausprobiert wurden, sind unter anderem die Euklidische Distanz und die Gower Distanz, die aber beide zu schlechteren Ergebnissen, gemessen anhand der definierten Bewertungskriterien, geführt haben. In Abschnitt \ref{weitere-versuche} werden diese weiteren Versuche grob dargestellt.
...
Es wurde auch in Betracht gezogen, eine allgemeine Saisonbereinigung durchzuführen. Dabei wurde ursprünglich angedacht, die Saisonbereinigung anhand der vier Jahreszeiten, Winter, Frühling, Sommer und Herbst durchzuführen. In Abbildungen \ref{fig:werteMslp} und \ref{fig:werteGeopot} sind die Werte des Luftdrucks bzw. Geopotentials aufgeteilt nach den Jahrezeiten dargestellt. Vor allem der Luftdruck zeigt kaum Unterschiede in Bezug auf die Saison. Der Median liegt für alle bei etwas unter $1020 hPa$. Nur die Streuung fällt im Sommer etwas geringer aus als in den anderen Jahrezeiten. \textcolor{red}{fertig}
...
Da in den Clustern 1, 2 und 3 vorwiegend Wintertage und in den Clustern 4, 5 und 6 hauptsächlich Sommertage sind, siehe Abschnitt \ref{verhaeltnis-von-sommer--und-wintertagen-in-den-clustern}, erscheint eine Analyse mit zwei getrennten Jahreszeiten hier sinnvoll.
