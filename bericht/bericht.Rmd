...
+-------------------------------------+---------------------------------------------------------------------------------+
| Zeile Minimum                       | Zeile $y_{max}$, in dem sich Maximum befindet; $y_{max} = 1, 2, 3$              |
+-------------------------------------+---------------------------------------------------------------------------------+
...
+-------------------------------------+---------------------------------------------------------------------------------+
| Mittelwerte in jeweils 9 Quadranten | Mittelwerte in den Quadranten                                                   |
+-------------------------------------+---------------------------------------------------------------------------------+
...
In Tabelle \ref{tab:gewichte} sieht man die Kategorien mit ihren Variablen und Gewichten.

+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
| Nr | Kategorie                            | Variablen                                                                                        | An zahl | Gewicht         |
+====+======================================+==================================================================================================+:=======:+:===============:+
| 1  | Verteilungsvariablen Mslp I          | Minimum, Maximum, Mittelwert                                                                     | 3       | $\frac  {1}{3}$ |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
|    |                                      |                                                                                                  |         |                 |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
| 2  | Verteilungsvariablen Geopotential I  | Minimum, Maximum, Mittelwert                                                                     | 3       | $\frac  {1}{3}$ |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
|    |                                      |                                                                                                  |         |                 |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
| 3  | Verteilungsvariablen Mslp II         | Median, Quartile, Intensität Hoch, Intensität Tief, Veränderung über den Tag                     | 6       | $\frac  {1}{6}$ |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
|    |                                      |                                                                                                  |         |                 |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
| 4  | Verteilungsvariablen Geopotential II | Median, Quartile, Intensität Hoch, Intensität Tief, Veränderung über den Tag                     | 6       | $\frac  {1}{6}$ |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
|    |                                      |                                                                                                  |         |                 |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
| 5  | Räumliche Ebene Mslp I               | Spalte und Zeile für Minimum/Maximum, Distanz zwischen Extrema, Distanz der beiden Minima/Maxima | 6       | $\frac  {1}{6}$ |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
|    |                                      |                                                                                                  |         |                 |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
| 6  | Räumliche Ebene Geopotential I       | Spalte und Zeile für Minimum/Maximum, Distanz zwischen Extrema, Distanz der beiden Minima/Maxima | 6       | $\frac  {1}{6}$ |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
|    |                                      |                                                                                                  |         |                 |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
| 7  | Räumliche Ebene Mslp II              | Mittelwerte in den 9 Quadranten                                                                  | 9       | $\frac  {1}{9}$ |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
|    |                                      |                                                                                                  |         |                 |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
| 8  | Räumliche Ebene Geopotential II      | Mittelwerte in den 9 Quadranten                                                                  | 9       | $\frac  {1}{9}$ |
+----+--------------------------------------+--------------------------------------------------------------------------------------------------+---------+-----------------+
...
Die Werte des Luftdrucks im Winter streuen mehr als im Sommer (Abb. \ref{fig:distribution_season_mslp}) und die Werte des Geopotentials im Sommer höher sind als im Winter (Abb. \ref{fig:distribution_season_geopot})
Um diese saisonalen Unterschiede zu berücksichtigen und die Verteilung der Winter- und Sommertagen in den Clustern zu betrachten, wird das Kalenderjahr in eine Winter- und in eine Sommerzeit aufgeteilt. Diese Aufteilung des Jahres  erfoglt nach Vorlage der Publikation von James P.M. 2006. 
Alle Tage im Zeitraum 16. Oktober bis 15. April werden als Wintertage definiert, die restlichen Tage folglich als Sommertage.(James P.M., 2006)

```{r distribution_seasom_mslp, echo = FALSE, fig.cap="\\label{fig:distribution_season_mslp}Darstellung der Verteilung des Luftdrucks über die 160 Messpunkte aufgeteilt in Sommer- und Winterzeit im Zeitraum 1971 - 2000", fig.align="center", out.width="80%"}
include_graphics("assets/jahreszeit_geo.png")
```

```{r distribution_seasom_geopot, echo = FALSE, fig.cap="\\label{fig:distribution_season_geopot}Darstellung der Verteilung des Geopotentials über die 160 Messpunkte aufgeteilt in Sommer- und Winterzeit im Zeitraum 1971 - 2000", fig.align="center", out.width="80%"}
include_graphics("assets/jahreszeit_mslp.png")
```
