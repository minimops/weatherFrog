...
gwl1971 <- gwl_data_split[year %in% seq(1971, 2010), ]


#reanalysis datensatz
...
table(cli_data_05_avg_wide$year,cli_data_05_avg_wide$month)
table(gwl_5_years$year,gwl_5_years$month)
